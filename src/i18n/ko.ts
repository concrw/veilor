...
export const ko: LocaleResource = {
  ...
  auth: {
    ...
    appleLoginFailTitle: 'Apple 로그인 실패',
    signOutTitle: '로그아웃',
  ...
  meExtra: {
    ...
    settingsSheet: {
      ...
      subscriptionManageHint: '탭하여 App Store에서 관리 또는 취소',
  ...
  loginPage: {
    ...
    errAppleFailed: 'Apple 로그인에 실패했습니다. 잠시 후 다시 시도해 주세요.',
    errAppleGeneric: 'Apple 로그인 중 오류가 발생했습니다.',
  ...
  sexSelfQuestions: {
    ...
    ageGateTitle: '성인 인증 필요',
    ageGateBody: '이 섹션은 성인(만 19세 이상)을 위한 콘텐츠를 포함합니다. 계속하려면 만 19세 이상임을 확인해 주세요.',
    ageGateConfirm: '만 19세 이상입니다 — 계속하기',
    ageGateDecline: '뒤로 가기',
    ageGateDeclined: '이 콘텐츠는 만 19세 이상 이용자를 위한 내용입니다.',
  },
  ...
  adminDomain: {
    dashboard: {
      ...
      tabs: [
        ...
        { key: 'b2b' as const,         label: 'B2B 조직 관리' },
        { key: 'virtual' as const,     label: '가상유저 활동' },
        { key: 'ai_interest' as const, label: 'AI 관심 유저' },
      ],
      statCards: {
        totalVirtual: '전체 유저',
        withSession: '세션 보유 유저',
        multiGroup: '복합 그룹 유저',
        multiGroupSub: '2개 이상 그룹',
        avgGroup: '평균 그룹 수',
        avgGroupSuffix: (n: string) => `${n}개`,
      },
      sections: {
        funnel: { title: '온보딩 퍼널', sub: '단계별 전환율', convRate: '전환율' },
        fragDist: { title: '프래그먼트 분포', sub: '보유 프래그먼트 수 기준' },
        groupDist: { title: '그룹 분포', sub: '주 그룹 vs 프래그먼트 그룹' },
        groupCountDist: { title: '그룹 수 분포', sub: '유저당 그룹 보유 수' },
        groupCountSuffix: (n: string) => `${n}개 그룹`,
        maskDist: { title: '마스크 분포', sub: '마스크 타입별 유저 수' },
        attachDist: { title: '애착 유형 분포', sub: '애착 유형별 유저 수' },
        concernDist: { title: '주요 관심사 분포', sub: '1순위 관심사 기준' },
        relationDist: { title: '관계 상태 분포', sub: '현재 관계 상태 기준' },
        fragNameDist: { title: '프래그먼트 이름 분포', sub: '가장 많이 선택된 프래그먼트' },
        axisAvg: { title: '4축 평균 점수', sub: '전체 유저 기준 4축 평균' },
        axisDist: { title: '4축 분포', sub: '축별 점수 분포 히스토그램' },
      },
      axisLabels: ['애착', '소통', '표현', '역할'],
  ...
  vfileResult: {
    ...
    guestNudge: 'Social Persona를 확인하셨습니다. 회원가입 하신 뒤에 General Persona와 Secret Persona도 확인하고 마이페이지에서 Persona를 관리해보세요.',
