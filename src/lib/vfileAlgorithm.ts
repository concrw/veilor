...
export const MASK_PROFILES: MaskProfile[] = [
  // ── 포식형 6종 ──────────────────────────────────────────────────
  // V-NEED 기반 좌표: A=SAF-SEC(높을수록 불안형), B=CON-INT(높을수록 개방), C=EXS-AUT(높을수록 직접표현), D=GRW-PWR-P(높을수록 주도)
  {
