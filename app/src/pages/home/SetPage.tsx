...
const AI_DATA = {
  amber: {
    ...
    replies: [
      { text: '그 감정, 충분히 느껴도 돼요.', tone: '공감해요' },
      { text: '작은 것부터 시작해요. 작은 게 더 오래가요.', tone: '격려해요' },
      { text: '오늘 어땠어요?', tone: '함께 있어요' },
    ],
  },
  frost: {
    ...
    replies: [
      { text: '이 반응이 몇 번이나 반복됐어요?', tone: '정확하게 짚어요' },
      { text: '변화는 알아채는 것에서 시작해요.', tone: '패턴을 추적해요' },
      { text: '3주면 바뀌기 시작해요.', tone: '냉철하게 지지해요' },
    ],
  },
};
